...
@section('title', 'Tambah Subagen')
@section('head', 'Tambah Subagen')
...
@section('content')
<form id="form-subagent-create" method="post" action="{{ url('api/subagent') }}" class="form-horizontal">
	{!! csrf_field() !!}
	<div class="row">
					...
					<div class="form-group">
						...
						@if ($user->isAdmin())
							<select name="agent_id" class="form-control">
								<option value="" data-id="null" selected disabled>Pilih Agen...</option>
								@foreach ($agents as $a)
								<option value="{{ $a->id }}">{{ $a->name }}</option>
								@endforeach
							</select>
						@elseif ($user->isAgent())
							<b>{{ $user->handleable->name }}</b>
						@endif
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" class="form-control" name="contract_value" min="50" max="200" required>
		...
		<div class="col-xs-12 col-md-6">
			...
			<div id="andila-subagent-user" class="box box-primary">
				<div class="box-header with-border">
						...
						<div class="col-sm-9">
							<div class="input-group">
								<span class="input-group-btn">
									<button id="clone-email" class="btn btn-default" type="button" data-toggle="tooltip" data-placement="right" title="Samakan dengan e-mail subagen">
...
@section('scripts')
<script src="{!! asset('js/app/inner/subagents/create.js') !!}"></script>
