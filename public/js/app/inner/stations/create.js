...
// Handle create station form submition
body.on('submit', '#form-station-create', function () {
	...
	var data = {
		...
		type: andila.form.get(form, 'type'),
		address: {}
	};
	...
	andila.api.post(andila.apiLocation + '/stations', data).done(function (res) {
		andila.html.btnSuccess(submit);
		andila.helper.redirect(andila.appLocation + '/stations', {post: res.model.id});
	}).fail([function () {
