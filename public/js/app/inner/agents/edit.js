...
// Handle edit agent form submition
body.on('submit', '#form-agent-edit', function () {
	...
	andila.api.put(andila.apiLocation + '/agents/' + andila.form.get(form, 'id'), data).done(function (res) {
		andila.html.btnSuccess(submit);
		andila.helper.redirect(andila.appLocation + '/agents', {put: res.model.id});
	}).fail([function () {
